# Functional test suite V1.0

Electron + IPC regression for JARVIS desktop release V1.0. Run via root `pnpm test:functional`.
...
| `05-task-board-approvals` P2 | Multica harness not in V1.0 suite |
